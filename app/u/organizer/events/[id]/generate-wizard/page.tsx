                                    ...
                                    {batches.map((batch, index) => (
                                        <div key={index} className="flex flex-col md:flex-row md:items-end gap-4 bg-zinc-950 p-4 rounded-xl border border-zinc-800 relative group animate-in slide-in-from-left duration-300">
                                            <div className="flex-1 space-y-2">
                                                ...
                                                <div className="w-full bg-zinc-900 border-zinc-800 rounded-lg p-3 text-white font-medium">
                                                    {batch.stand}
                                                </div>
                                            </div>
                                            <div className="w-full md:w-32 space-y-2">
                                                <Label className="text-zinc-400 text-xs font-bold uppercase">Price (₦)</Label>
                                                <input
                                                    type="number"
                                                    placeholder="0"
                                                    min="0"
