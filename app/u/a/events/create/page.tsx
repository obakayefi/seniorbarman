...
const CreateEvent = () => {
  return (
    <div className='h-screen flex-col flex items-center justify-center bg-slate-100 p-4 lg:p-20'>
        <div>
            <h1 className="text-4xl text-center text-orange-600">CreateEvent</h1>
            <p className='text-gray-400 text-center'>Events you create here can be shown on the homepage</p>
        </div>

        <section className="mt-4 w-full items-center flex justify-center sm:w-2/3 ">
            <CreateEventForm />
        </section>
    </div>
  )
